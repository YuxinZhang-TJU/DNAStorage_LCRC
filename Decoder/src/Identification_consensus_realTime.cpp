 ...
 *
 * @brief: Real-time readout of oligo pools along with nanopore sequencing
 *
 *************************************/
#include <cstdlib>
#include <cstdio>
...
const char *refer_file = "reference/DNA_oligoPool/oligoPool.fa"; // reference FASTA
...
int main(int argc, char *argv[])
{
    ...
    while (1)
    {
        ...
        if (enhanced_mode && n_reads_BWA > 0)
        {
