...
./run_decoding_online.sh ./fastq
```

Here, _./fastq_ refers to the directory where the sequencing data files are stored
...
- _\${threshold}_: Correlation threshold (default value: 0.8).
- _\${mode}_: Running mode (use 0 for the correlation-based scheme and 1 for the alignment-based scheme).
- _\${base_threshold}_: Base available ratio (default value: 0.938).
